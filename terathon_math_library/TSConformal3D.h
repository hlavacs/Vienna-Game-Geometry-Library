...
namespace Terathon
{
	...
	class RoundPoint3D
	{
		public:
			...
			RoundPoint3D(real ax, real ay, real az, real aw, real au)
			{
				x = ax;
				y = ay;
				z = az;
			...
			RoundPoint3D& Set(real ax, real ay, real az, real aw, real au)
			{
				x = ax;
				y = ay;
				z = az;
			...
			void Set(real ax, real ay, real az, real aw, real au) volatile
			{
				x = ax;
				y = ay;
				z = az;
			...
			real& operator [](machine k)
			{
				return ((&x)[k]);
			}

			const real& operator [](machine k) const
			{
				return ((&x)[k]);
			}

			RoundPoint3D& operator *=(real n)
			{
				x *= n;
				y *= n;
				z *= n;
	...
	inline RoundPoint3D operator *(const RoundPoint3D& a, real n)
	{
	...
	inline RoundPoint3D operator *(real n, const RoundPoint3D& a)
	{
	...
	class Dipole3D
	{
		public:
			...
			Dipole3D(real vx, real vy, real vz, real mx, real my, real mz, real px, real py, real pz, real pw)
			{
				v.Set(vx, vy, vz);
				m.Set(mx, my, mz);
				p.Set(px, py, pz, pw);
			...
			Dipole3D& Set(real vx, real vy, real vz, real mx, real my, real mz, real px, real py, real pz, real pw)
			{
				v.Set(vx, vy, vz);
				m.Set(mx, my, mz);
				p.Set(px, py, pz, pw);
			...
			void Set(real vx, real vy, real vz, real mx, real my, real mz, real px, real py, real pz, real pw) volatile
			{
				v.Set(vx, vy, vz);
				m.Set(mx, my, mz);
				p.Set(px, py, pz, pw);
	...
	inline Dipole3D operator *(const Dipole3D& d, real n)
	{
	...
	inline Dipole3D operator *(real n, const Dipole3D& d)
	{
	...
	class Circle3D
	{
		public:
			...
			Circle3D(real gx, real gy, real gz, real gw, real vx, real vy, real vz, real mx, real my, real mz)
			{
				g.Set(gx, gy, gz, gw);
				v.Set(vx, vy, vz);
				m.Set(mx, my, mz);
			...
			Circle3D& Set(real gx, real gy, real gz, real gw, real vx, real vy, real vz, real mx, real my, real mz)
			{
				g.Set(gx, gy, gz, gw);
				v.Set(vx, vy, vz);
				m.Set(mx, my, mz);
			...
			void Set(real gx, real gy, real gz, real gw, real vx, real vy, real vz, real mx, real my, real mz) volatile
			{
				g.Set(gx, gy, gz, gw);
				v.Set(vx, vy, vz);
				m.Set(mx, my, mz);
	...
	inline Circle3D operator *(const Circle3D& c, real n)
	{
	...
	inline Circle3D operator *(real n, const Circle3D& c)
	{
	...
	class Sphere3D
	{
		public:
			...
			Sphere3D(real su, real sx, real sy, real sz, real sw)
			{
				u = su;
				x = sx;
				y = sy;
			...
			Sphere3D& Set(real su, real sx, real sy, real sz, real sw)
			{
				u = su;
				x = sx;
				y = sy;
			...
			void Set(real su, real sx, real sy, real sz, real sw) volatile
			{
				u = su;
				x = sx;
				y = sy;
	...
	inline Sphere3D operator *(const Sphere3D& s, real n)
	{
	...
	inline Sphere3D operator *(real n, const Sphere3D& s)
	{
	...
	inline real Attitude(const RoundPoint3D& a)
	{
		return (a.w);
	}
	...
	inline real SquaredRadiusNorm(const RoundPoint3D& a)
	{
	...
	inline real SquaredRadiusNorm(const Dipole3D& d)
	{
	...
	inline real SquaredRadiusNorm(const Circle3D& c)
	{
	...
	inline real SquaredRadiusNorm(const Sphere3D& s)
	{
	...
	inline real SquaredCenterNorm(const RoundPoint3D& a)
	{
	...
	inline real SquaredCenterNorm(const Dipole3D& d)
	{
	...
	inline real SquaredCenterNorm(const Circle3D& c)
	{
	...
	inline real SquaredCenterNorm(const Sphere3D& s)
	{
	...
	inline real SquaredBulkNorm(const RoundPoint3D& a)
	{
		return (a.x * a.x + a.y * a.y + a.z * a.z);
	}
	...
	inline real SquaredBulkNorm(const Dipole3D& d)
	{
	...
	inline real SquaredBulkNorm(const Circle3D& c)
	{
		return (c.g.w * c.g.w);
	}
	...
	inline real SquaredBulkNorm(const Sphere3D& s)
	{
		return (0.0F);
	}
	...
	inline real SquaredWeightNorm(const RoundPoint3D& a)
	{
		return (a.w * a.w);
	}
	...
	inline real SquaredWeightNorm(const Dipole3D& d)
	{
	...
	inline real SquaredWeightNorm(const Circle3D& c)
	{
	...
	inline real SquaredWeightNorm(const Sphere3D& s)
	{
		return (s.u * s.u);
	}
	...
	inline real SquaredFlatBulkNorm(const RoundPoint3D& a)
	{
		return (a.u * a.u);
	}
	...
	inline real SquaredFlatBulkNorm(const Dipole3D& d)
	{
	...
	inline real SquaredFlatBulkNorm(const Circle3D& c)
	{
	...
	inline real SquaredFlatBulkNorm(const Sphere3D& s)
	{
		return (s.w * s.w);
	}
	...
	inline real SquaredFlatWeightNorm(const RoundPoint3D& a)
	{
		return (0.0F);
	}
	...
	inline real SquaredFlatWeightNorm(const Dipole3D& d)
	{
		return (d.p.w * d.p.w);
	}
	...
	inline real SquaredFlatWeightNorm(const Circle3D& c)
	{
	...
	inline real SquaredFlatWeightNorm(const Sphere3D& s)
	{
		return (s.x * s.x + s.y * s.y + s.z * s.z);
	}
