...
namespace Terathon
{
	...
	class Bivector3D : public Antivec3D<TypeBivector3D>
	{
		public:
			...
			Bivector3D(real a, real b, real c) : Antivec3D<TypeBivector3D>(a, b, c) {}

			template <typename type>
			explicit Bivector3D(const Antivec3D<type>& v) : Antivec3D<TypeBivector3D>(real(v.x), real(v.y), real(v.z)) {}

			/// \brief Sets all three components of a 3D bivector.
			/// \param a,b,c	The new components of the bivector.

			Bivector3D& Set(real a, real b, real c)
			{
				xyz.Set(a, b, c);
				return (*this);
			}
	...
	inline Bivector3D operator *(const Bivector3D& v, real n)
	{
	...
	inline Bivector3D operator *(real n, const Bivector3D& v)
	{
	...
	inline real Magnitude(const Bivector3D& v)
	{
	...
	inline real InverseMag(const Bivector3D& v)
	{
	...
	inline real SquaredMag(const Bivector3D& v)
	{
	...
	inline real Dot(const Bivector3D& a, const Bivector3D& b)
	{
	...
	inline real Antiwedge(const Bivector3D& a, const Vector3D& b)
	{
		return (a.xyz ^ b.xyz);
	}

	inline real Antiwedge(const Vector3D& a, const Bivector3D& b)
	{
		return (a.xyz ^ b.xyz);
	}

	template <typename type_struct, int count, int index_x, int index_y, int index_z>
	inline real Antiwedge(const Bivector3D& a, const Subvec3D<type_struct, false, count, index_x, index_y, index_z>& b)
	{
		return (a.xyz ^ b);
	}
	...
	inline real operator ^(const Bivector3D& a, const Vector3D& b) {return (Antiwedge(a, b));}
	inline real operator ^(const Vector3D& a, const Bivector3D& b) {return (Antiwedge(a, b));}

	template <typename type_struct, int count, int index_x, int index_y, int index_z>
	inline real operator ^(const Bivector3D& a, const Subvec3D<type_struct, false, count, index_x, index_y, index_z>& b) {return (Antiwedge(a, b));}
