...
#if defined(VGEO_DOUBLE_PRECISION)

const real Math::infinity =			std::numeric_limits<double>::infinity();
const real Math::minus_infinity =		-std::numeric_limits<double>::infinity();
const real Math::min_float =			std::numeric_limits<double>::min();
const real Math::max_float =			std::numeric_limits<double>::max();

#else

const real Math::infinity =			(float&) hex_7F800000;
const real Math::minus_infinity =		(float&) hex_FF800000;
const real Math::min_float =			(float&) hex_00800000;
const real Math::max_float =			(float&) hex_7F7FFFFF;

#endif

const real Math::tau =					6.2831853071795864769252867665590;
const real Math::two_tau =				12.566370614359172953850573533118;
const real Math::three_tau_over_4 =	4.7123889803846898576939650749193;
const real Math::three_tau_over_8 =	2.3561944901923449288469825374596;
const real Math::tau_over_2 =			3.1415926535897932384626433832795;
const real Math::tau_over_3 =			2.0943951023931954923084289221863;
const real Math::two_tau_over_3 =		4.1887902047863909846168578443727;
const real Math::tau_over_4 =			1.5707963267948966192313216916398;
const real Math::tau_over_6 =			1.0471975511965977461542144610932;
const real Math::tau_over_8 =			0.78539816339744830961566084581988;
const real Math::tau_over_12 =			0.52359877559829887307710723054658;
const real Math::tau_over_16 =			0.39269908169872415480783042290994;
const real Math::tau_over_24 =			0.26179938779914943653855361527329;
const real Math::tau_over_40 =			0.15707963267948966192313216916398;
const real Math::one_over_tau =		1.0 / Math::tau;
const real Math::two_over_tau =		2.0 / Math::tau;
const real Math::four_over_tau =		4.0 / Math::tau;
const real Math::one_over_two_tau =	0.5 / Math::tau;

const real Math::pi =					3.1415926535897932384626433832795;
const real Math::two_pi =				6.2831853071795864769252867665590;
const real Math::four_pi =				12.566370614359172953850573533118;
const real Math::three_pi_over_2 =		4.7123889803846898576939650749193;
const real Math::three_pi_over_4 = 	2.3561944901923449288469825374596;
const real Math::two_pi_over_3 =		2.0943951023931954923084289221863;
const real Math::four_pi_over_3 = 		4.1887902047863909846168578443727;
const real Math::pi_over_2 =			1.5707963267948966192313216916398;
const real Math::pi_over_3 =			1.0471975511965977461542144610932;
const real Math::pi_over_4 =			0.78539816339744830961566084581988;
const real Math::pi_over_6 =			0.52359877559829887307710723054658;
const real Math::pi_over_8 =			0.39269908169872415480783042290994;
const real Math::pi_over_12 =			0.26179938779914943653855361527329;
const real Math::pi_over_20 =			0.15707963267948966192313216916398;
const real Math::one_over_pi =			1.0 / Math::pi;
const real Math::one_over_two_pi =		0.5 / Math::pi;
const real Math::one_over_four_pi =	0.25 / Math::pi;

const real Math::sqrt_2 =				1.4142135623730950488016887242097;
const real Math::sqrt_2_over_2 =		0.70710678118654752440084436210485;
const real Math::sqrt_2_over_3 =		0.47140452079103168293389624140323;
const real Math::sqrt_3 =				1.7320508075688772935274463415059;
const real Math::sqrt_3_over_2 =		0.86602540378443864676372317075294;
const real Math::sqrt_3_over_3 =		0.57735026918962576450914878050196;

const real Math::ln_2 =				0.69314718055994530941723212145818;
const real Math::one_over_ln_2 =		1.4426950408889634073599246810019;
const real Math::ln_10 =				2.3025850929940456840179914546844;
const real Math::one_over_ln_10 =		0.43429448190325182765112891891661;
const real Math::ln_256 =				5.5451774444795624753378569716654;
...
namespace
{
	...
	inline const TrigPair *GetTrigTable(void)
	{
		...
		real Terathon::Floor(const real& x)
		{
			return (std::floor(x));
		}

		real Terathon::Ceil(const real& x)
		{
			return (std::ceil(x));
		}
...
real Terathon::Sqrt(real x)
{
	return (std::sqrt(x));
}

real Terathon::InverseSqrt(real x)
{
...
real Terathon::Sin(real x)
{
	return (std::sin(x));
}

real Terathon::Cos(real x)
{
	return (std::cos(x));
}

real Terathon::Tan(real x)
{
	return (std::tan(x));
}

void Terathon::CosSin(real x, real *c, real *s)
{
	*c = std::cos(x);
	*s = std::sin(x);
}

real Terathon::Arcsin(real y)
{
	return (std::asin(y));
}

real Terathon::Arccos(real x)
{
	return (std::acos(x));
}

real Terathon::Arctan(real x)
{
	return (std::atan(x));
}

real Terathon::Arctan(real y, real x)
{
	return (std::atan2(y, x));
}

real Terathon::Exp(real x)
{
	return (std::exp(x));
}

real Terathon::Log(real x)
{
	return (std::log(x));
}
