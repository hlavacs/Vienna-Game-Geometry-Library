...
namespace Terathon
{
	...
	class Motor2D
	{
		public:
			...
			Motor2D(real a, real b, real c, real d)
			{
				x = a;
				y = b;
				z = c;
			...
			Motor2D& Set(real a, real b, real c, real d)
			{
				x = a;
				y = b;
				z = c;
			...
			static Motor2D MakeRotation(real angle, const Point2D& center)
			{
	...
	inline Motor2D operator *(const Motor2D& Q, real n)
	{
	...
	inline Motor2D operator *(real n, const Motor2D& Q)
	{
	...
	inline real SquaredBulkNorm(const Motor2D& Q)
	{
	...
	inline real SquaredWeightNorm(const Motor2D& Q)
	{
