...
namespace Terathon
{
	...
	DualNum operator +(const DualNum& d, real a)
	{
	...
	DualNum operator *(const DualNum& d, real b)
	{
		return (DualNum(d.s * b, d.t * b));
	}

	DualNum operator *(real b, const DualNum& d)
	{
	...
	DualNum WedgeDot(const DualNum& d, real a)
	{
		return (DualNum(d.s * a, d.t * a));
	}

	DualNum WedgeDot(real a, const DualNum& d)
	{
	...
	DualNum AntiwedgeDot(const DualNum& d, real b)
	{
		return (DualNum(d.s * b, d.t * b));
	}

	DualNum AntiwedgeDot(real b, const DualNum& d)
	{
		return (DualNum(b * d.s, b * d.t));
	}
