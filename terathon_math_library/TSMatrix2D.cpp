...
Matrix2D::Matrix2D(real n00, real n01, real n10, real n11) : Mat2D<TypeMatrix2D>(n00, n01, n10, n11)
{
}
...
Matrix2D& Matrix2D::Set(real n00, real n01, real n10, real n11)
{
...
Matrix2D Matrix2D::MakeRotation(real angle)
{
	Vector2D v = CosSin(angle);
	return (Matrix2D(v.x, -v.y, v.y,  v.x));
}

Matrix2D Matrix2D::MakeScale(real scale)
{
	return (Matrix2D(scale, 0.0F, 0.0F, scale));
}

Matrix2D Matrix2D::MakeScale(real sx, real sy)
{
	return (Matrix2D(sx, 0.0F, 0.0F, sy));
}

Matrix2D Matrix2D::MakeScaleX(real sx)
{
	return (Matrix2D(sx, 0.0F, 0.0F, 1.0F));
}

Matrix2D Matrix2D::MakeScaleY(real sy)
{
	return (Matrix2D(1.0F, 0.0F, 0.0F, sy));
}


Matrix2D Terathon::operator *(const Matrix2D& m, real s)
{
...
real Terathon::Determinant(const Matrix2D& m)
{
