...
{
	real v2 = d.v.x * d.v.x + d.v.y * d.v.y + d.v.z * d.v.z;
	real f = d.p.w * d.p.w - d.m.x * d.m.x - d.m.y * d.m.y - d.m.z * d.m.z - d.v.x * d.p.x - d.v.y * d.p.y - d.v.z * d.p.z;
...
{
	real g2 = c.g.x * c.g.x + c.g.y * c.g.y + c.g.z * c.g.z;
	real f = c.g.w * c.g.w - c.v.x * c.v.x + c.v.y * c.v.y + c.v.z * c.v.z - c.g.x * c.m.x - c.g.y * c.m.y - c.g.z * c.m.z;
