...
namespace Terathon
{
	...
	class Matrix4D : public Mat4D<TypeMatrix4D>
	{
		public:
			...
			TERATHON_API Matrix4D(real n00, real n01, real n02, real n03, real n10, real n11, real n12, real n13, real n20, real n21, real n22, real n23, real n30, real n31, real n32, real n33);
			...
			TERATHON_API Matrix4D(const Bivector3D& r0, real n03, const Bivector3D& r1, real n13, const Bivector3D& r2, real n23, const Bivector3D& r3, real n33);
			...
			TERATHON_API Matrix4D& Set(real n00, real n01, real n02, real n03, real n10, real n11, real n12, real n13, real n20, real n21, real n22, real n23, real n30, real n31, real n32, real n33);
	...
	TERATHON_API real Determinant(const Matrix4D& m);
	...
	class Transform3D : public Matrix4D
	{
		public:
			...
			TERATHON_API Transform3D(real n00, real n01, real n02, real n03, real n10, real n11, real n12, real n13, real n20, real n21, real n22, real n23);
			...
			TERATHON_API Transform3D(const Bivector3D& r0, real n03, const Bivector3D& r1, real n13, const Bivector3D& r2, real n23);
			...
			TERATHON_API Transform3D& Set(real n00, real n01, real n02, real n03, real n10, real n11, real n12, real n13, real n20, real n21, real n22, real n23);
			...
			Transform3D& SetTranslation(real x, real y, real z)
			{
				m03 = x;
				m13 = y;
				m23 = z;
			...
			TERATHON_API void GetEulerAngles(real *x, real *y, real *z) const;
			TERATHON_API Transform3D& SetEulerAngles(real x, real y, real z);
			...
			TERATHON_API static Transform3D MakeRotationX(real angle);

			/// \brief Returns a 4&#x202F;&times;&#x202F;4 transform that represents a rotation about the <i>y</i> axis.
			/// \param angle	The angle through which to rotate, in radians.

			TERATHON_API static Transform3D MakeRotationY(real angle);

			/// \brief Returns a 4&#x202F;&times;&#x202F;4 transform that represents a rotation about the <i>z</i> axis.
			/// \param angle	The angle through which to rotate, in radians.

			TERATHON_API static Transform3D MakeRotationZ(real angle);
			...
			TERATHON_API static Transform3D MakeRotation(real angle, const Bivector3D& axis);
			...
			TERATHON_API static Transform3D MakeScale(real scale);

			TERATHON_API static Transform3D MakeScale(real sx, real sy, real sz);
			TERATHON_API static Transform3D MakeScale(real scale, const Vector3D& axis);
			TERATHON_API static Transform3D MakeScaleX(real sx);
			TERATHON_API static Transform3D MakeScaleY(real sy);
			TERATHON_API static Transform3D MakeScaleZ(real sz);

			TERATHON_API static Transform3D MakeSkew(real angle, const Vector3D& a, const Vector3D& b);
	...
	TERATHON_API real Determinant(const Transform3D& m);
