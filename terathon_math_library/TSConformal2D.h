...
namespace Terathon
{
	...
	class RoundPoint2D
	{
		public:
			...
			RoundPoint2D(real ax, real ay, real az, real aw)
			{
				x = ax;
				y = ay;
				z = az;
			...
			RoundPoint2D& Set(real ax, real ay, real az, real aw)
			{
				x = ax;
				y = ay;
				z = az;
			...
			void Set(real ax, real ay, real az, real aw) volatile
			{
				x = ax;
				y = ay;
				z = az;
	...
	inline RoundPoint2D operator *(const RoundPoint2D& a, real n)
	{
	...
	inline RoundPoint2D operator *(real n, const RoundPoint2D& a)
	{
	...
	class Dipole2D
	{
		public:
			...
			Dipole2D(real gx, real gy, real gz, real px, real py, real pz)
			{
				g.Set(gx, gy, gz);
				p.Set(px, py, pz);
			}
			...
			Dipole2D& Set(real gx, real gy, real gz, real px, real py, real pz)
			{
				g.Set(gx, gy, gz);
				p.Set(px, py, pz);
				return (*this);
			...
			void Set(real gx, real gy, real gz, real px, real py, real pz) volatile
			{
				g.Set(gx, gy, gz);
				p.Set(px, py, pz);
			}
	...
	inline Dipole2D operator *(const Dipole2D& d, real n)
	{
	...
	inline Dipole2D operator *(real n, const Dipole2D& d)
	{
	...
	class Circle2D
	{
		public:
			...
			Circle2D(real cw, real cx, real cy, real cz)
			{
				w = cw;
				x = cx;
				y = cy;
			...
			Circle2D& Set(real cw, real cx, real cy, real cz)
			{
				w = cw;
				x = cx;
				y = cy;
			...
			void Set(real cw, real cx, real cy, real cz) volatile
			{
				w = cw;
				x = cx;
				y = cy;
	...
	inline Circle2D operator *(const Circle2D& c, real n)
	{
	...
	inline Circle2D operator *(real n, const Circle2D& c)
	{
	...
	inline real Attitude(const RoundPoint2D& a)
	{
		return (-a.z);
	}
	...
	inline real SquaredRadiusNorm(const RoundPoint2D& a)
	{
	...
	inline real SquaredRadiusNorm(const Dipole2D& d)
	{
	...
	inline real SquaredRadiusNorm(const Circle2D& c)
	{
	...
	inline real SquaredCenterNorm(const RoundPoint2D& a)
	{
	...
	inline real SquaredCenterNorm(const Dipole2D& d)
	{
	...
	inline real SquaredCenterNorm(const Circle2D& c)
	{
	...
	inline real SquaredBulkNorm(const RoundPoint2D& a)
	{
		return (a.x * a.x + a.y * a.y);
	}
	...
	inline real SquaredBulkNorm(const Dipole2D& d)
	{
		return (d.g.z * d.g.z);
	}
	...
	inline real SquaredBulkNorm(const Circle2D& c)
	{
		return (0.0F);
	}
	...
	inline real SquaredWeightNorm(const RoundPoint2D& a)
	{
		return (a.z * a.z);
	}
	...
	inline real SquaredWeightNorm(const Dipole2D& d)
	{
	...
	inline real SquaredWeightNorm(const Circle2D& c)
	{
		return (c.w * c.w);
	}
	...
	inline real SquaredFlatBulkNorm(const RoundPoint2D& a)
	{
		return (a.w * a.w);
	}
	...
	inline real SquaredFlatBulkNorm(const Dipole2D& d)
	{
	...
	inline real SquaredFlatBulkNorm(const Circle2D& c)
	{
		return (c.z * c.z);
	}
	...
	inline real SquaredFlatWeightNorm(const RoundPoint2D& a)
	{
		return (0.0F);
	}
	...
	inline real SquaredFlatWeightNorm(const Dipole2D& d)
	{
		return (d.p.z * d.p.z);
	}
	...
	inline real SquaredFlatWeightNorm(const Circle2D& c)
	{
		return (c.x * c.x + c.y * c.y);
	}
