...
namespace Terathon
{
	...
	class Flector2D
	{
		public:
			...
			Flector2D(real a, real b, real c, real d)
			{
				x = a;
				y = b;
				z = c;
			...
			Flector2D& Set(real a, real b, real c, real d)
			{
				x = a;
				y = b;
				z = c;
	...
	inline Flector2D operator *(const Flector2D& F, real n)
	{
	...
	inline Flector2D operator *(real n, const Flector2D& F)
	{
	...
	inline real SquaredBulkNorm(const Flector2D& F)
	{
	...
	inline real SquaredWeightNorm(const Flector2D& F)
	{
