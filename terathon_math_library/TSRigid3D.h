...
namespace Terathon
{
	...
	class FlatPoint3D : public Vector4D
	{
		public:
			...
			FlatPoint3D(real a, real b, real c, real d) : Vector4D(a, b, c, d) {}

			FlatPoint3D(const Point3D& p) : Vector4D(p) {}
			FlatPoint3D(const Vector3D& v) : Vector4D(v) {}
			FlatPoint3D(const Vector3D& v, real d) : Vector4D(v, d) {}
	...
	inline FlatPoint3D operator *(const FlatPoint3D& p, real n)
	{
	...
	inline FlatPoint3D operator *(real n, const FlatPoint3D& p)
	{
	...
	class Line3D
	{
		public:
			...
			Line3D(real vx, real vy, real vz, real mx, real my, real mz)
			{
				v.Set(vx, vy, vz);
				m.Set(mx, my, mz);
			}
			...
			Line3D& Set(real vx, real vy, real vz, real mx, real my, real mz)
			{
				v.Set(vx, vy, vz);
				m.Set(mx, my, mz);
				return (*this);
			...
			void Set(real vx, real vy, real vz, real mx, real my, real mz) volatile
			{
				v.Set(vx, vy, vz);
				m.Set(mx, my, mz);
			}
	...
	inline Line3D operator *(const Line3D& l, real n)
	{
	...
	inline Line3D operator *(real n, const Line3D& l)
	{
	...
	class Plane3D : public Antivec4D<TypePlane3D>
	{
		public:
			...
			Plane3D(real a, real b, real c, real d) : Antivec4D<TypePlane3D>(a, b, c, d) {}

			Plane3D(const Bivector3D& n, real d)
			{
				xyz = n.xyz;
				w = d;
			}
			...
			Plane3D& Set(real a, real b, real c, real d)
			{
				xyzw.Set(a, b, c, d);
				return (*this);
			}

			void Set(real a, real b, real c, real d) volatile
			{
				xyzw.Set(a, b, c, d);
			}
			...
			Plane3D& Set(const Bivector3D& n, real d)
			{
				xyz.Set(n.x, n.y, n.z);
				w = d;
				return (*this);
			...
			void Set(const Bivector3D& n, real d) volatile
			{
				xyz.Set(n.x, n.y, n.z);
				w = d;
			}
	...
	inline Plane3D operator *(const Plane3D& g, real n)
	{
	...
	inline Plane3D operator *(real n, const Plane3D& g)
	{
	...
	inline real Attitude(const FlatPoint3D& p)
	{
		return (p.w);
	}
	...
	inline real SquaredBulkNorm(const FlatPoint3D& p)
	{
	...
	inline real SquaredBulkNorm(const Line3D& l)
	{
	...
	inline real SquaredBulkNorm(const Plane3D& g)
	{
		return (g.w * g.w);
	}
	...
	inline real SquaredWeightNorm(const FlatPoint3D& p)
	{
		return (p.w * p.w);
	}
	...
	inline real SquaredWeightNorm(const Line3D& l)
	{
	...
	inline real SquaredWeightNorm(const Plane3D& g)
	{
	...
	inline real Dot(const FlatPoint3D& a, const FlatPoint3D& b)
	{
	...
	inline real Dot(const Line3D& k, const Line3D& l)
	{
	...
	inline real Dot(const Plane3D& g, const Plane3D& h)
	{
		return (g.w * h.w);
	}
	...
	inline real Antidot(const FlatPoint3D& a, const FlatPoint3D& b)
	{
		return (a.w * b.w);
	}
	...
	inline real Antidot(const Line3D& k, const Line3D& l)
	{
	...
	inline real Antidot(const Plane3D& g, const Plane3D& h)
	{
	...
	inline real Antiwedge(const Line3D& k, const Line3D& l)
	{
	...
	inline real Antiwedge(const FlatPoint3D& p, const Plane3D& g)
	{
		return (p.xyzw ^ g.xyzw);
	}

	inline real Antiwedge(const Point3D& p, const Plane3D& g)
	{
		return ((p.xyz ^ g.xyz) + g.w);
	}

	inline real Antiwedge(const Vector3D& v, const Plane3D& g)
	{
		return (v ^ g.xyz);
	}

	inline real Antiwedge(const Point2D& p, const Plane3D& g)
	{
	...
	inline real operator ^(const Line3D& k, const Line3D& l) {return (Antiwedge(k, l));}
	inline real operator ^(const FlatPoint3D& p, const Plane3D& g) {return (Antiwedge(p, g));}
	inline real operator ^(const Point3D& p, const Plane3D& g) {return (Antiwedge(p, g));}
	inline real operator ^(const Vector3D& v, const Plane3D& g) {return (Antiwedge(v, g));}
	inline real operator ^(const Point2D& p, const Plane3D& g) {return (Antiwedge(p, g));}
