...
namespace Terathon
{
	...
	class Subvec2D
	{
		public:
			...
			Subvec2D& operator /=(const real& s)
			{
				real t = 1.0F / s;
				data[index_x] *= t;
				data[index_y] *= t;
	...
	class Subvec3D
	{
		public:
			...
			Subvec3D& operator /=(const real& s)
			{
				real t = 1.0F / s;
				data[index_x] *= t;
				data[index_y] *= t;
			...
			{
				return (*this *= InverseSqrt(real(data[index_x] * data[index_x] + data[index_y] * data[index_y] + data[index_z] * data[index_z])));
			}
	};
	...
	class Subvec4D
	{
		public:
			...
			Subvec4D& operator /=(const real& s)
			{
				real t = 1.0F / s;
				data[index_x] *= t;
				data[index_y] *= t;
	...
	inline real operator ^(const Subvec3D<A_type_struct, A_anti, A_count, A_index_x, A_index_y, A_index_z>& A, const Subvec3D<B_type_struct, !A_anti, B_count, B_index_x, B_index_y, B_index_z>& B)
	{
		return (A.data[A_index_x] * B.data[B_index_x] + A.data[A_index_y] * B.data[B_index_y] + A.data[A_index_z] * B.data[B_index_z]);
	}
	...
	inline real operator ^(const Subvec4D<A_type_struct, false, A_count, A_index_x, A_index_y, A_index_z, A_index_w>& A, const Subvec4D<B_type_struct, true, B_count, B_index_x, B_index_y, B_index_z, B_index_w>& B)
	{
		return (A.data[A_index_x] * B.data[B_index_x] + A.data[A_index_y] * B.data[B_index_y] + A.data[A_index_z] * B.data[B_index_z] + A.data[A_index_w] * B.data[B_index_w]);
	}
	...
	inline real operator ^(const Subvec4D<A_type_struct, false, A_count, A_index_x, A_index_y, A_index_z, A_index_w>& A, const Subvec3D<B_type_struct, true, B_count, B_index_x, B_index_y, B_index_z>& B)
	{
		return (A.data[A_index_x] * B.data[B_index_x] + A.data[A_index_y] * B.data[B_index_y] + A.data[A_index_z] * B.data[B_index_z]);
	}
	...
	inline real operator ^(const Subvec3D<A_type_struct, false, A_count, A_index_x, A_index_y, A_index_z>& A, const Subvec4D<B_type_struct, true, B_count, B_index_x, B_index_y, B_index_z, B_index_w>& B)
	{
		return (A.data[A_index_x] * B.data[B_index_x] + A.data[A_index_y] * B.data[B_index_y] + A.data[A_index_z] * B.data[B_index_z]);
	}
	...
	class Submat2D
	{
		public:
			...
			Submat2D& operator /=(const real& s)
			{
				real t = 1.0F / s;
				data[index_00] *= t;
				data[index_10] *= t;
	...
	class Submat3D
	{
		public:
			...
			Submat3D& operator /=(const real& s)
			{
				real t = 1.0F / s;
				data[index_00] *= t;
				data[index_10] *= t;
	...
	class Submat4D
	{
		public:
			...
			Submat4D& operator /=(const real& s)
			{
				real t = 1.0F / s;
				data[index_00] *= t;
				data[index_10] *= t;
