...
namespace Terathon
{
	...
	class Motor3D
	{
		public:
			...
			Motor3D(real vx, real vy, real vz, real vw, real mx, real my, real mz, real mw)
			{
				v.Set(vx, vy, vz, vw);
				m.Set(mx, my, mz, mw);
			}
			...
			Motor3D& Set(real vx, real vy, real vz, real vw, real mx, real my, real mz, real mw)
			{
				v.Set(vx, vy, vz, vw);
				m.Set(mx, my, mz, mw);
				return (*this);
			...
			void Set(real vx, real vy, real vz, real vw, real mx, real my, real mz, real mw) volatile
			{
				v.Set(vx, vy, vz, vw);
				m.Set(mx, my, mz, mw);
			}
			...
			static Motor3D MakeRotation(real angle, const Bivector3D& axis)
			{
			...
			static Motor3D MakeScrew(real angle, const Line3D& axis, real disp)
			{
				disp *= 0.5F;
				Vector2D t = CosSin(angle * 0.5F);
	...
	inline Motor3D operator *(const Motor3D& Q, real n)
	{
	...
	inline Motor3D operator *(real n, const Motor3D& Q)
	{
	...
	inline real SquaredBulkNorm(const Motor3D& Q)
	{
	...
	inline real SquaredWeightNorm(const Motor3D& Q)
	{
